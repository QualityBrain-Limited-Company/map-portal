        ...
        <div>
          ...
          <div className="space-y-1">
            <div className="text-sm text-slate-600">
              กำลังแสดง: <span className="font-medium text-slate-900">{filteredDocs.length} / {documents.length} รายการ</span>
            </div>
            {categories.map(cat => {
